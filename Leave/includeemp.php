        ...
        <!-- Sidebar -->
         <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="../Attendance/employee_dashboard.php" class="list-group-item list-group-item-action bg-black second-text ">
                ...
                <a href="../Leave/leave.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">Leave</a>
                 <a href="../Attendance/viewleave.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">Previous Leave</a>
              
                <a href="../Attendance/viewReportsE.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">Reports</a>

...
if (mysqli_num_rows($result) == 1) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "INSERT INTO leave_records (employee_no,employee_id, fullname, start_date, end_date,leave_type,status, reason)
                        VALUES ('$employee_no','$employee_id', '$fullname', '$start_date', '$end_date','$leave_type', 
                        'pending..','$reason')";
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <select name="leave_type" id="leave_type" required>
                    ...
                    <option value="Cassual Leave">Cassual Leave</option>
